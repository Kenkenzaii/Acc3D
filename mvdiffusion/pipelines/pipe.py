...
from diffusers.loaders import LoraLoaderMixin, FromSingleFileMixin, IPAdapterMixin, TextualInversionLoaderMixin
...
class StableUnCLIPImg2ImgPipeline(DiffusionPipeline,
    ...
    def __call__(
        ...
        for i, t in enumerate(self.progress_bar(timesteps)):
            ...
            # return_unet_list.append(noise_pred)
            ...
            # if i % 1 == 0:  
            #     num_views = 6
            #     decoded_image = self.decode_latents(latents,return_type="tensor")
            #     bsz = decoded_image.shape[0] // 2
            #     normals_pred = decoded_image[:bsz] # [6, 3, 512, 512]
            #     images_pred = decoded_image[bsz:] # [6, 3, 512, 512]
            #     for j in range(bsz//num_views):
            #             scene =  batch['filename'][j].split('.')[0]
            ...
            #                 normal_filename = f"normals_{view}_masked_{i}.png"
            #                 rgb_filename = f"color_{view}_masked_{i}.png"
