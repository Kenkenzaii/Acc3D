...
from diffusers.loaders import TextualInversionLoaderMixin, LoraLoaderMixin, IPAdapterMixin, FromSingleFileMixin
...
class UNetMV2DConditionModel(ModelMixin, 
                             ConfigMixin, 
    ...
    def __init__(
        ...
        # self.multi_features = MultiFeature()
    ...
    def forward(
        ...
        t_emb = self.time_proj(timesteps) # [24, 1280]
        ...
        # 2. pre-process
        sample = self.conv_in(sample) # [24, 320, 64, 64]
        # 3. down
        ...
        for i, downsample_block in enumerate(self.down_blocks):
            if hasattr(downsample_block, "has_cross_attention") and downsample_block.has_cross_attention:
                ...
                sample, res_samples = downsample_block(
                    ...
                    **additional_residuals,
                )  # [24, 320, 64, 64], [3, 24, 320, 64, 64] -> 32 -> 16 -> 8
            else:
        ...
        # OUTPUT: down_block_res_samples  [24, 1280, 8, 8]
        ...
        # after mid block sample: [24, 1280, 8, 8]    
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            if hasattr(upsample_block, "has_cross_attention") and upsample_block.has_cross_attention:
                ...
                mv_features.append(sample) # [24, 1280, 32, 32] [24, 640, 64, 64] [24, 320, 64, 64]
            else:
                sample = upsample_block(
        ...
        # mv_features = self.multi_features(mv_features)
        if not return_dict:
            return (sample, pose_pred, mv_features)
        if self.regress_elevation or self.regress_focal_length:
